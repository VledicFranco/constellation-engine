# Organon System Ethos

> Version 1.0 — Meta-Level Organon
>
> Behavioral constraints for LLMs and humans working on the organon system.
...
4. **Philosophy/Ethos per scope.** Each feature/component has PHILOSOPHY.md and ETHOS.md.
...
7. **Generated catalogs are read-only.** Never edit `organon/generated/*.md` manually.
...
| Protocol | 100 | `organon/protocols/<name>.md` |
...
| Situation | Action |
|-----------|--------|
| Adding new organon | Find the right feature/component, update parent README |
| Modifying organon | Verify against code, update all references |
...
| Generated | `organon/generated/` | What exists (signatures) |
| Organon | `organon/components/*/ETHOS.md` | What it means (semantics) |

See [Semantic Mapping Protocol](./protocols/semantic-mapping.md) for bridging layers.

---

## Dual Surface Consistency

| Aspect | `organon/` (LLM) | `website/docs/` (Human) |
|--------|------------------|-------------------------|
| Same facts | Yes | Yes |
