...
> **Path**: `organon/features/execution/cold-execution.md`
...
- [website/docs/api-reference/execution.md](../../http-api/execution.md) - Full API reference
- [website/docs/api-reference/pipelines.md](../../http-api/pipelines.md) - Pipeline management
