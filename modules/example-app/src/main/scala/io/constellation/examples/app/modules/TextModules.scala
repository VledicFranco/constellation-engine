...
object TextModules {
  ...
  val uppercase: Module.Uninitialized = ModuleBuilder
    .metadata(
      name = "Uppercase",
      description = "Converts all characters in the input text to uppercase. Useful for normalizing text before comparison or formatting headers.",
      majorVersion = 1,
      minorVersion = 0
    )
    .tags("text", "transform")
  ...
  val lowercase: Module.Uninitialized = ModuleBuilder
    .metadata(
      name = "Lowercase",
      description = "Converts all characters in the input text to lowercase. Ideal for case-insensitive string operations and normalization.",
      majorVersion = 1,
      minorVersion = 0
    )
    .tags("text", "transform")
  ...
  val trim: Module.Uninitialized = ModuleBuilder
    .metadata(
      name = "Trim",
      description = "Removes leading and trailing whitespace from text, including spaces, tabs, and newlines. Essential for cleaning user input.",
      majorVersion = 1,
      minorVersion = 0
    )
    .tags("text", "transform")
  ...
  val replace: Module.Uninitialized = ModuleBuilder
    .metadata(
      name = "Replace",
      description = "Replaces all occurrences of a substring with another string. Performs literal string replacement (not regex).",
      majorVersion = 1,
      minorVersion = 0
    )
    .tags("text", "transform")
  ...
  val wordCount: Module.Uninitialized = ModuleBuilder
    .metadata(
      name = "WordCount",
      description = "Counts the number of words in text by splitting on whitespace. Empty strings are not counted as words.",
      majorVersion = 1,
      minorVersion = 0
    )
    .tags("text", "analysis")
  ...
  val textLength: Module.Uninitialized = ModuleBuilder
    .metadata(
      name = "TextLength",
      description = "Returns the number of characters in the text string. Counts all characters including spaces and special characters.",
      majorVersion = 1,
      minorVersion = 0
    )
    .tags("text", "analysis")
  ...
  val contains: Module.Uninitialized = ModuleBuilder
    .metadata(
      name = "Contains",
      description = "Checks if the text contains a specific substring. Returns true if found, false otherwise. Case-sensitive.",
      majorVersion = 1,
      minorVersion = 0
    )
    .tags("text", "analysis")
  ...
  val splitLines: Module.Uninitialized = ModuleBuilder
    .metadata(
      name = "SplitLines",
      description = "Splits text into a list of lines by newline characters. Returns a list containing each line as a separate string.",
      majorVersion = 1,
      minorVersion = 0
    )
    .tags("text", "split")
  ...
  val split: Module.Uninitialized = ModuleBuilder
    .metadata(
      name = "Split",
      description = "Splits text by a custom delimiter string. Returns a list of substrings found between the delimiters.",
      majorVersion = 1,
      minorVersion = 0
    )
    .tags("text", "split")
