...
object StringUtils:
   ...
   * @return The truncated string, or original if short enough
   */
   ...
   * @return Truncated hash with ellipsis (e.g., "7a3b8c9d1234...")
   */
   ...
   * @return Truncated ID with ellipsis (e.g., "550e8400...")
   */
  ...
  /**
   * Safely truncate and display a timestamp for preview.
   * Removes timezone information for compact display.
   *
   * @param timestamp The ISO timestamp string
   * @return Truncated timestamp (e.g., "2026-02-08T00:00:00")
   */
