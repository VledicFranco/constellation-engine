...
```scala
val execution: IO[CancellableExecution] =
  constellation.runDagCancellable("pipeline", inputs)

// New Constellation method:
...
See the [SPI Integration Guides](../integrations/spi/) for implementation examples.
...
- [Embedding Guide](../embedding-guide.md) — complete setup for embedding in your JVM app
- [Security Model](../security.md) — trust boundaries and HTTP hardening details
- [Performance Tuning](../performance-tuning.md) — scheduler, circuit breakers, caching
- [Error Reference](../error-reference.md) — all error codes and resolutions
- [SPI Integration Guides](../integrations/spi/) — implementations for popular libraries
