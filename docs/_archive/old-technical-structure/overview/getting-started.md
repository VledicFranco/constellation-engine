...
| Issue | Solution |
|-------|----------|
| `sbt: command not found` | Install SBT 1.10+ from https://www.scala-sbt.org/download.html |
...
| [API Guide](api-guide.md) | Programmatic usage and advanced patterns |
| [LSP Integration](LSP_INTEGRATION.md) | IDE features and configuration |
