...
See [CacheBackend Integration Guide](integrations/spi/cache-backend.md) for Redis and Caffeine implementations.
...
See [MetricsProvider Integration Guide](integrations/spi/metrics-provider.md) for Prometheus and Datadog examples.
