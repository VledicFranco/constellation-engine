...
- [io.constellation.<pkg>](/docs/generated/io.constellation.<pkg>.md)
...
Add the component to `docs/components/README.md` if it exists, or create one:
...
- [ ] `docs/components/<name>/ETHOS.md` exists
