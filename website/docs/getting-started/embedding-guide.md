...
sidebar_position: 3
description: "Embed Constellation Engine into your JVM application"
---
...
See the [SPI Integration Guides](../integrations/metrics-provider.md) for implementation examples with popular libraries.
