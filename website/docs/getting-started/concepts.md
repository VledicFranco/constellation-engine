...
title: "Core Concepts"
sidebar_position: 2
description: "Key concepts and architecture of Constellation Engine"
---
...
See the [HTTP API Overview](/docs/api-reference/http-api-overview) for full endpoint documentation.
...
- Browse the [Examples](./examples/) for common pipeline patterns
- Check the [HTTP API Reference](/docs/api-reference/http-api-overview) for endpoint details
- See the [Embedding Guide](./embedding-guide) to integrate Constellation into your JVM application
